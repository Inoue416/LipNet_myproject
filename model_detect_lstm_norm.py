...
class LstmNet(nn.Module):
    ...
    def forward(self, x1):
        ...
        # x = torch.reshape(x1, (
        #     x1.size(0), x1.size(2), x1.size(1)
        # ))
        x = torch.reshape(hn1, (
            hn1.size(1), hn1.size(0)*hn1.size(2)
        ))
...
#     data = torch.randn(16, 1120, 1)
#     model = LstmNet()
#     out = model(data)
#     print(out.size())
#     label = torch.randint(0, 7, (16,), dtype=torch.long)
