...
model_name = 'lipnet'
color_mode = 'gray'
save_prefix = f'_w_{year}_{month}_{day}_t{train_num}v{val_num}_decay{decay}_dp{dropout_p}_vp{vid_padding}_tp{txt_padding}_batch{batch_size}_ep{max_epoch}_{anno_kind}_{data_len}_{model_mode}_{model_name}_{color_mode}/{year}_{month}_{day}_t{train_num}v{val_num}_Wdecay0_dp0.30_LipNet+rand_{data_type}'
is_optimize = True
